                ...
                <form action="${pageContext.request.contextPath}/post/list" method="post">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <select id="postStatus" class="form-control" name="poster">
                        ...
                        <div class="col-md-3 btn-group align-self-end">
                            ...
                            <tr >
                                ...
                                <td class="center">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <button class="btn btn-outline-info">Deactivate Post</button>
                                        </c:otherwise>
                                    </c:choose>                            
                                </td>
                            </tr>
