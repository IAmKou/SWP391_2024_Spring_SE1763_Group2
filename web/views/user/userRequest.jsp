                ...
                <div class="col-md-10 ">
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <form id="filterForm" action="${pageContext.request.contextPath}/booking/view" method="post">
                                <div class="row m-4">
                                    <div class="col-md-3">
                                        ...
                                        <tbody>
                                            <c:forEach items="${bookings}" var="booking">
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <c:choose>
                                                            <c:when test="${booking.booking.getBooking_id() eq 0}">
                                                                Visiting
                                                            </c:when>
                                                            <c:otherwise>
                                                                Booking
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${booking.booking.getBooking_id() eq 0}">
                                                                <span style="color: ${booking.meeting.getMeetingStatus().getStatus_id() == 1 ? 'gray' : 
                                                                                      booking.meeting.getMeetingStatus().getStatus_id() == 2 ? 'green' : 
                                                                                      booking.meeting.getMeetingStatus().getStatus_id() == 3 ? 'red' : 'black'}">
                                                                          ${booking.meeting.getMeetingStatus().getStatus_name()}
                                                                      </span>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <span style="color: ${booking.booking.getStatus().getStatus_id() == 1 ? 'gray' : 
                                                                                          booking.booking.getStatus().getStatus_id() == 2 ? 'green' : 
                                                                                          booking.booking.getStatus().getStatus_id() == 3 ? 'red' : 'black'}">
